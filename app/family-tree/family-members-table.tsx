...
export function FamilyMembersTable({
  ...
  const handleOpenEditDialog = (member: FamilyMember) => {
    ...
    setFormData({
      ...
      birthday_calendar: member.birthday_calendar ?? "",
      death_date_calendar: member.death_date_calendar ?? "",
  ...
  const handleSubmitMember = async (e: React.FormEvent) => {
    ...
    const memberData = {
      ...
      birthday_calendar: formData.birthday_calendar || null,
      death_date_calendar: (!formData.is_alive && formData.death_date_calendar) ? formData.death_date_calendar : null,
              ...
              <div className="grid gap-4">
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, courtesy_name: e.target.value })
                    }
                    className="col-span-3"
                  />
                </div>
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  <Label htmlFor="pseudonym" className="text-right">
                    号
                  </Label>
                  <Input
                    id="pseudonym"
                ...
                {/* 农历/传统纪年出生 */}
                <div className="grid grid-cols-4 items-center gap-4">
                  <Label htmlFor="birthday_calendar" className="text-right">
                    农历/纪年
                  </Label>
                  <Input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, birthday_calendar: e.target.value })
                    }
                    className="col-span-3"
                    placeholder="如：光绪十七年三月初五"
                  />
                </div>
                ...
                {!formData.is_alive && (
                  <>
                    ...
                    <div className="grid grid-cols-4 items-center gap-4">
                      <Label htmlFor="death_date_calendar" className="text-right">
                        农历/纪年
                      </Label>
                      <Input
                        id="death_date_calendar"
                        value={formData.death_date_calendar}
                        onChange={(e) =>
                          setFormData({ ...formData, death_date_calendar: e.target.value })
                        }
                        className="col-span-3"
                        placeholder="如：民国三十三年四月初四日酉时"
                      />
                    </div>
                  </>
                )}
